...
// Implementation from https://github.com/v-v/karkkainen-sanders
// released under GPL v2 (see LICENSE file)
...
public class SuffixArray {
	...
	public static int[] constructSuffixArray(String sequence) {
		int[] int_seq = sequence.chars().map(x -> {
				if (x=='A') { return 1; }
		...
		return constructSuffixArray(int_seq, 5);
	}
